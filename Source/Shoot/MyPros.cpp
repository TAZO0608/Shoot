...
void AMyPros::SetPool(UMyPool* inPool)
{
	if (inPool == nullptr) { return; }
	//UE_LOG(LogTemp, Warning, TEXT("[%s] Setting Pool %s"), *(this->GetName()), *(inPool->GetName()));
	Pool = inPool;
}
void AMyPros::PlaceActors(TSubclassOf<AActor> ToSpawn, int MinSpawn, int MaxSpawn, float Radius, bool AlwaysSpawn,int RotMode, float ScaleBasis)
{
